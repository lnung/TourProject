...
public interface CourseStringQuery {
	   ...
	   String GET_COURSE_BY_NUM= "select * from course_info where course_num = ? ORDER BY course_order";
	   
	   String GET_ATTRACTION_BY_SPOT_NAME = "SELECT * FROM tourspot WHERE spot_name=?";
}
